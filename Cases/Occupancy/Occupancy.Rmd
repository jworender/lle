...
if (TRUE) {
  ...
  plot(mod_rf2, data = ds_test1, title = "Random Forest with Selected Features (Test Set #1)")
  plot(mod_rf2, data = ds_test2a, title = "Random Forest with Selected Features (Test Set #2)")
}
```
